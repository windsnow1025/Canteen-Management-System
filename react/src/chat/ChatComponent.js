      ...
      <>
          ...
          <div className="flex items-center justify-center h-screen bg-gray-200">
              <div className="p-8 bg-white rounded shadow-lg">
                  ...
                  <div className="mb-4">
        <span className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${connected ? 'text-green-600 bg-green-200' : 'text-red-600 bg-red-200'}`}>
          {connected ? 'Connected' : 'Disconnected'}
                  ...
                  />
                  <button onClick={handleSend} disabled={!connected} className="px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed">
                      Send
                  </button>
                  <div className="mt-8">
